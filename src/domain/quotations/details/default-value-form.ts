export const DEFAULT_QUOTATION_DETAIL_FORM_VALUE = {
  quotationConditions: 
`  All prices quoted are in US Dollars, Ex Works Australia.
  ...
  paymentTerms: 
`  50% upon confirmation of order. Advance payment received shall be forfeited should there be any cancellation of order subsequently. 
  ...
  deliveryLeadTime: "12 – 16 weeks upon order confirmation and payment duly received by RGB, subject to variable component availability.",
...
`  Regulatory Compliance
  ...
  appendixB: 
`  Force Majeure (to be taken and construed as an essential and integral part of this Quotation). 
