...
1. Link Spinning Reel Gaming Machines (Video and Stepper): one hundred twenty percent (120%) of the ATNW for all spinning reel game machines. 
  
2. BEPS Warranty. No warranty is provided for BEPS Software.
  `,
...
export const quotationHeaderOptions: THeaderPrint[] = [
  ...
  },
  {
    title: "RGB Sdn. Bhd.",
    company: "RGB",
    header: `${process.env.GATSBY_MEDUSA_BACKEND_URL}${process.env.GATSBY_RGB_SDN_HEADER}`,
    footer: `${process.env.GATSBY_MEDUSA_BACKEND_URL}${process.env.GATSBY_RGB_SDN_FOOTER}`,
  },
  {
    title: "RGB Pte. Ltd.",
    company: "RGB",
    header: `${process.env.GATSBY_MEDUSA_BACKEND_URL}${process.env.GATSBY_RGB_FTE_HEADER}`,
    footer: `${process.env.GATSBY_MEDUSA_BACKEND_URL}${process.env.GATSBY_RGB_FTE_FOOTER}`,
  },
  {
    title: "PETRO SOLUTIONS PTE LTD.",
    company: "PETRO SOLUTIONS",
    header: `${process.env.GATSBY_MEDUSA_BACKEND_URL}${process.env.GATSBY_PETRO_SDN_HEADER}`,
    footer: `${process.env.GATSBY_MEDUSA_BACKEND_URL}${process.env.GATSBY_PETRO_SDN_FOOTER}`,
  },
  {
    title: "PETRO SOLUTIONS SDN BHD.",
    company: "PETRO SOLUTIONS",
    header: `${process.env.GATSBY_MEDUSA_BACKEND_URL}${process.env.GATSBY_PETRO_FTE_HEADER}`,
    footer: `${process.env.GATSBY_MEDUSA_BACKEND_URL}${process.env.GATSBY_PETRO_FTE_FOOTER}`,
  },
];
